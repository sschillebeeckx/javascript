...
function validateForm(){
    ...
    console.log(id);
    if (id==="" ){
        let idErrorField=document.getElementById('idError');
        idErrorField.value = 'id is required';
        idErrorField.style.display = 'block';
        return false;
    }
}
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log(button);
    button.addEventListener("click", (event) => addNewCourse(event));
